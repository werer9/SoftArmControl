...
import math
from detect import *
from yolov5.depth import pred, depth_image
...
def putText(color_image, angle1, angle2, angleRotate, softArmCommands, fps, greenRate, yellowRate, baseRate):
    # softarmcommands -> [joint angles, rotation angle, command type ]
    # (0 = neutral, 1 = bear,2 = human, 3=headpat. 4 =deflate, 5= speak, 6=wave)

    if softArmCommands[2] == 0:
        mode = "neutral"
