...
class LoadImages:  # for inference
    def __init__(self, path, img_size=1280, stride=32):
...
class LoadWebcam:  # for inference
    def __init__(self, pipe='0', img_size=1280, stride=32):
        self.img_size = img_size
        self.stride = stride
...
class LoadStreams:  # multiple IP or RTSP cameras
    def __init__(self, sources='streams.txt', img_size=1280, stride=32):
        self.mode = 'stream'
        self.img_size = img_size
        self.stride = stride
